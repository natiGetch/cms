...
export const faqsSchema = mongoose.models.faqSchema || mongoose.model("faqSchema", faqSchema);
export const FaqTranslation = mongoose.models.faqTranslationSchema || mongoose.model("faqTranslationSchema", faqTranslationSchema);
